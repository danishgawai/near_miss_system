...
class AppConfig:
    # I/O
    source_stream: str = "traffic_clipped01.mp4"
    ...
    track_max_box_ratio: float = 0.45
    min_track_age_for_risk: int = 4
    ...
    hard_brake_min_speed_mps: float = 3.0
